/**
 * middleware.ts — Combined middleware for Özgül's Realty
 *
 * Duplicate of proxy.ts for Vercel deployment compatibility.
 * Next.js 16 uses proxy.ts locally, but Vercel may still require middleware.ts.
 *
